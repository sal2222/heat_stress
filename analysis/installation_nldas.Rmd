...
```{r combined_dataframe, warning = FALSE}
# Create index to substiture installation name into master dataframe `.id`
...
nldas_df <-
  list.files("data/base_nldas", full.names = TRUE) %>%
    .[-c(27, 10)] %>%   # remove West Point and Fort Huachuca
...
# write_rds(nldas_df, path = "data/base_nldas/nldas_df.rds")
